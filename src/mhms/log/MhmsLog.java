...
/**
 * log
 * mhmslog(Context context,int Int,String string)
 *£ºHealthReport_CREATE£»MedicineRecord_CREATE
 * ;HealthSurvey_CREATE; EyeSight_Test ;BMI_Test
 * ;HeartRate_Test ;Medicine_Reminder ; HealthDiets_Select
 * ;Online_Searching ;System_Setting;
 */
public class MhmsLog {
	...
	public static final int Health_Food_Select = 8;//perform a healthy diet choice
	 ...
	 * @param string
	 *            log, write current act description, add a health report, have a eyesight testing
	 */
