...
public class HealthReport_Camera extends Activity {
	...
	float heightFloat = 0, weightFloat = 0, eyesightFloat = 0, bloodpressureFloat = 0, bloodsugarFloat = 0,
			bloodlipidFloat = 0;
	int heartrateInt = 0;
	...
	private String jsonparse(String key) {
		String keyStr;
		try {
			JSONObject jsonobj = new JSONObject(heathreport_camera_get);
