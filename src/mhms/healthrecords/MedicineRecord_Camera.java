...
public class MedicineRecord_Camera extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		save_to_medicinerecord.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				dbinsert();
				MhmsLog.mhmslog(MedicineRecord_Camera.this, MhmsLog.MedicineRecord_CREATE, "add QR code medicine record");
	...
	private String jsonparse(String key){
		String keyStr;
		try{JSONObject jsonobj = new JSONObject(medicinerecord_camera_get);
		keyStr=jsonobj.getString(key);
		}
		catch (JSONException e){keyStr=null;}
		return keyStr;
	}
    ...
    private void parse_medicinerecord_camera_get(){ 
			 ...
			 medicinerecord_camera_result.setText("disease name:"+illname+"\n"+"begin date:"+illbegin+"\n"+"end date:"+illend+"\n"+"medicine record:"+pillusing+"\n"+
...
public boolean onMenuOpened(int featureId, Menu menu) {
	...
	MenuAction addmenu = new MenuAction(MedicineRecord_Camera.this);// create object of menu
