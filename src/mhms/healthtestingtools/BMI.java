		...
		startBMI.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (weightStr.equals("") || weightStr.equals(null)
					...
					returnbuilder.setMessage("请输入正确身高和体重");
					returnbuilder.setTitle("提示");
					returnbuilder.setPositiveButton("确认",new android.content.DialogInterface.OnClickListener() {
										@Override
										public void onClick(DialogInterface dialog,int which) {
											dialog.dismiss();
										}
									});
					returnbuilder.setNegativeButton("取消",
	...
	protected void initPopupWindow() {
		...
		okbmi.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// close dialog
				dbinsert();
				MhmsLog.mhmslog(BMI.this, MhmsLog.BMI_Test, "进行了一次BMI计算");
				popupbmi.dismiss();
